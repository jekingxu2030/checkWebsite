...
class WebsiteMonitor(QWidget):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("网站可用性监控 - 针钟推送")
    ...
    def init_ui(self):
        ...
        h_layout_token.addWidget(QLabel("针钟 access_token："))
        ...
        while not self.stop_event.is_set():
            ...
            try:
                ...
                if status_code >= 400:
                    ...
                    self.update_status(f"[正常] 状态码：{status_code}，系统状态：{fault_type}")
