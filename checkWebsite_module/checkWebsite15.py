...
class WebsiteMonitor(QWidget):
    ...
    def init_ui(self):
        ...
        self.push_status_label = QLabel("推送状态")  # ✅ 推送状态显示
        self.push_status_label.setStyleSheet("color: gray; font-weight: bold;")
    ...
    def toggle_monitoring(self):
        if self.monitoring:
            ...
            self.update_push_status("")  # 清除推送状态
        else:
            ...
            monitor = Monitor(
                ...
                callback_push_status=self.update_push_status,  # ✅ 传递钉钉推送回调
    ...
    def update_push_status(self, text):
        QTimer.singleShot(
            0, lambda: self.push_status_label.setText(text)
        )  # ✅ 钉钉推送状态
